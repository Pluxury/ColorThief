...
{
    public class ColorThiefAndroid
    {
        /// <summary>
        ...
        /// <returns></returns>
        public QuantizedColor GetColor(Bitmap sourceImage, int quality = ColorThief.Shared.ColorThief.DefaultQuality, bool ignoreWhite = ColorThief.Shared.ColorThief.DefaultIgnoreWhite)
        {
            var palette = GetPalette(sourceImage, 3, quality, ignoreWhite);

            var dominantColor = new QuantizedColor(new ColorThief.Shared.Color
            {
        ...
        /// <returns></returns>
        /// <code>true</code>
        public List<QuantizedColor> GetPalette(Bitmap sourceImage, int colorCount = ColorThief.Shared.ColorThief.DefaultColorCount, int quality = ColorThief.Shared.ColorThief.DefaultQuality, bool ignoreWhite = ColorThief.Shared.ColorThief.DefaultIgnoreWhite)
        {
        ...
        private byte[][] GetPixelsFast(Bitmap sourceImage, int quality, bool ignoreWhite)
        {
            ...
            return new ColorThief.Shared.ColorThief().ConvertPixels(pixels, pixelCount, quality, ignoreWhite);
        }
    }
}
