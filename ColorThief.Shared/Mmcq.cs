...
namespace ColorThief.Shared
{
    public class Mmcq
    {
        ...
        private readonly VBoxComparer ComparatorProduct = new VBoxComparer();
        private readonly VBoxCountComparer ComparatorCount = new VBoxCountComparer();
        ...
        private int[] GetHisto(IEnumerable<byte[]> pixels)
        {
        ...
        private VBox VboxFromPixels(IList<byte[]> pixels, int[] histo)
        {
        ...
        private VBox[] DoCut(char color, VBox vbox, IList<int> partialsum, IList<int> lookaheadsum, int total)
        {
            int vboxDim1;
            int vboxDim2;
        ...
        private VBox[] MedianCutApply(IList<int> histo, VBox vbox)
        {
        ...
        private void Iter(List<VBox> lh, IComparer<VBox> comparator, int target, IList<int> histo)
        {
            var ncolors = 1;
            var niters = 0;
        ...
        public CMap Quantize(byte[][] pixels, int maxcolors)
        {
            // short-circuit
        ...
        public double CreateComparisonValue(double saturation, double targetSaturation, double luma, double targetLuma, int population, int highestPopulation)
        {
        ...
        private double WeightedMean(params double[] values)
        {
            double sum = 0;
            double sumWeight = 0;
        ...
        private double InvertDiff(double value, double targetValue)
        {
