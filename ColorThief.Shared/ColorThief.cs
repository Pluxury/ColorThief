...
namespace ColorThief.Shared
{
    public class ColorThief
    {
        ...
        /// <returns></returns>
        public CMap GetColorMap(byte[][] pixelArray, int colorCount)
        {
            ...
            var cmap = new Mmcq().Quantize(pixelArray, colorCount);
            return cmap;
        }

        public byte[][] ConvertPixels(byte[] pixels, int pixelCount, int quality, bool ignoreWhite)
        {
